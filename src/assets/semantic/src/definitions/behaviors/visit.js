        ...
        add: {
          id: function(id) {
            ...
            if( module.has.visited(id) ) {
              module.debug('Unique views already visited, not adding visit', id, currentIDs);
            }
            else if(id === undefined) {
              module.debug('ID is not defined');
            }
            else {
              module.debug('Adding visit to unique views', id);
        ...
        remove: {
          id: function(id) {
            ...
            if(id !== undefined && currentIDs !== undefined) {
              module.debug('Removing visit to unique views', id, currentIDs);
