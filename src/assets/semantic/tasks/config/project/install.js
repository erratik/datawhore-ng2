  ...
  createJSON: function(answers) {
    ...
    if(answers.dist) {
      ...
      json.paths.output = {
        ...
        uncompressed : path.normalize(answers.dist + '/wrapper/'),
        compressed   : path.normalize(answers.dist + '/wrapper/'),
  ...
  questions: {
    ...
    setup: [
      ...
      },
      {
        ...
        choices: [
          {
            name: 'Automatic (Use defaults locations and all wrapper)',
            value: 'auto'
          },
          {
            name: 'Express (Set wrapper and output folder)',
            value: 'express'
          },
          {
      ...
      },
      {
        type: 'checkbox',
        name: 'components',
        message: 'What wrapper should we include in the package?',
      ...
      },
      {
        type: 'input',
        name: 'compressed',
        message: 'Where should we output compressed wrapper?',
      ...
      },
      {
        type: 'input',
        name: 'uncompressed',
        message: 'Where should we output uncompressed wrapper?',
