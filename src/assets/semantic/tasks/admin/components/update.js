...
/*
  ...
  * Tag new releases if version changed in wrapper repo
  ...
  stepRepo = function() {
    ...
    var
      ...
      commitMessage = (isNewVersion)
        ...
        : 'Updated files from wrapper repo',
    ...
    if(localRepoSetup) {
      ...
      console.error('Repository must be setup before running update wrapper');
    }
